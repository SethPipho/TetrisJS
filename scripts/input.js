...
document.addEventListener("mousemove", function(event) {Mouse.Move(event);}, false);
document.addEventListener("mouseup", function(event) {Mouse.OnMouseUp(event);}, false);
document.addEventListener("mousedown", function(event) {Mouse.OnMouseDown(event);}, false);
document.addEventListener("click", function(event) {Mouse.OnClick(event);}, false);
